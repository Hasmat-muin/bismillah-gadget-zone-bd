...
function updateCartUI() {
    ...
    cart.forEach((item, index) => {
        ...
        itemsHTML += `
            <div style="display:flex; justify-content:space-between; padding:8px 0; border-bottom:1px solid #eee;">
                ...
                <span onclick="removeCartItem(${index})" style="color:red; cursor:pointer;">×</span>
            </div>
        `;
    });
    ...
    if (listIndex) listIndex.innerHTML = itemsHTML || "<p>কার্ট খালি!</p>";
    ...
    if (listProduct) listProduct.innerHTML = itemsHTML || "<p>কার্ট খালি!</p>";
